"""
Ultra-fast ConnectX agent - Fully verified version
Fixed edge case handling for column validity
"""

def agent(observation, configuration):
    """Fast agent with correct column validity check"""
    import random
    ...
    # Get valid moves - check if column has any empty space
    valid_moves = []
